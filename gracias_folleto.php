                ...
                <nav class="c-layout-quick-sidebar">
                    ...
                    <div class="c-content">
                        ...
                        <div class="c-section">
                            ...
                            <section id="Incio" style="background-image: url('assets/base/img/content/backgrounds/gracias-textura.jpg')">
                            ...
                            <section id="Incio">
                                <div class="intro c-size-md c-bg-grey-1" style="background-image: url('assets/base/img/content/backgrounds/aviso-textura.jpg'); background-repeat: no-repeat; background-attachment: fixed;">
                                    <div class="container-fluid">
                                        <div class="c-content-bar-2 c-opt-1">
                                            <div class="row my-5" data-auto-height="true">
                                                <div class="col-lg-2"></div>
                                                <div class="col-lg-8 col-md-8 col-sm-12 d-block m-auto">
                                                    <h1 class="text-center display-1">Gracias por tu información</h1>
                                                    <p class="text-center">Si necesitas atención inmediata contáctanos vía WhatsApp</p>
                                                    <a class="btn btn-success d-block m-auto btn-block" href="https://wa.me/525573552395"><i class="fab fa-whatsapp" style="color:white;"></i>Más información</a>
                                                    <br>
                                                    <br>
