                                ...
                                <nav class="c-mega-menu c-mega-menu-onepage c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold" data-onepage-animation-speed="700">
                                    <ul class="nav navbar-nav c-theme-nav">
                                        ...
                                        <li class="c-onepage-link">
                                            <a href="index.php#departamentos" class="c-link">Departamentos</a>
                                        </li>
                                        <li class="c-onepage-link">
                                            <a href="index.php#amenidades-desarrollo" class="c-link dropdown-toggle">Amenidades
                                                <span class="c-arrow c-toggler"></span>
                                            </a>
                                            <ul class="dropdown-menu c-menu-type-classic c-pull-left">
                                                <li class="c-onepage-link dropdown-submenu">
                                                    <a href="index.php#amenidades-desarrollo">Amenidades del desarrollo
                                                        <span class="c-arrow c-toggler"></span>
                                                    </a>
                                                </li>
                                                <li class="c-onepage-link dropdown-submenu">
                                        ...
                                        <li class="c-onepage-link ">
                                            <a href="index.php#promociones" class="c-link">Promociones</a>
                                        </li>
                                        <li class="c-onepage-link ">
                                            <a href="index.php#ubicacion" class="c-link">Ubicación</a>
                                        </li>
                                        <!--<li class="c-onepage-link ">
                                            <a href="#financiamiento" class="c-link">Financiamiento</a>
                                        </li>-->
                                        <li class="c-onepage-link ">
                                            <a href="index.php#avances" class="c-link">Avances de Obra</a>
                                        </li>
                                        <li class="c-onepage-link ">
                                            <a href="index.php#contacto" class="c-link">Contacto</a>
                                        </li>
                                        <li class="c-onepage-link ">
                                    ...
                                    <section class="c-layout-revo-slider c-layout-revo-slider-7" dir=
                                        ...
                                        <div class="tp-banner-container tp-fullscreen tp-fullscreen-mobile">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h1 class="c-font-36 c-font-bold c-font-uppercase c-font-white c-subtitle title-shadow" > Aviso de Privacidad</h1>
                                                        <br>
                                                        <br>
                                                        </h5>
                                                    </div>
                                        ...
                                        <div class="tp-banner rev_slider" data-version="5.0">
                                            <ul>
                                                ...
                                                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                                                    <img alt="" src="assets/base/img/content/backgrounds/aviso-textura.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
